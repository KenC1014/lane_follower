...
if __name__ == '__main__':
    ...
    lane_follow_path = rospack.get_path('lane_follow')
    sp_img_path = os.path.join(lane_follow_path, 'images', 'salt_and_pepper.jpg')
    ga_img_path = os.path.join(lane_follow_path, 'images', 'gaussian.jpg')
    result_sp_img_ga_filter_path = os.path.join(lane_follow_path, 'images', 'results',
    'salt_and_pepper_gaussian_filter.jpg')
    result_sp_img_me_filter_path = os.path.join(lane_follow_path, 'images', 'results',
    'salt_and_pepper_median_filter.jpg')
    result_ga_img_ga_filter_path = os.path.join(lane_follow_path, 'images', 'results',
    'gaussian_noise_gaussian_filter.jpg')
    result_ga_img_me_filter_path = os.path.join(lane_follow_path, 'images', 'results',
