...
class lanenet_detector():
    ...
    def gradient_thresh(self, img):
        ...
        edge_x = cv2.Sobel(img, ddepth=cv2.CV_64F, dx=1, dy=0, ksize=3)
        edge_y = cv2.Sobel(img, ddepth=cv2.CV_64F, dx=0, dy=1, ksize=3)
    ...
    def perspective_transform(self, img, verbose=False):
        ...
        # gazebo
        transform_points = {"x_tl": 293,    # 310 300 293
                            "x_tr": 347,    # 330 339 347
                            "y_t": 258,     # 246 253 258
                            "x_bl": 67,
                            "x_br": 564,
                            "y_b": 407,
        ...
        x_l_trans = (x_tl + x_bl) // 2 - 50
        x_r_trans = (x_tr + x_br) // 2 + 50
